    ...
    render() {
        return (
            <div className="about-main">
                <img className="about-img" src={about} alt="aboutme"/>
                ...
                <div className="about-content">
                    ...
                    <p>Besides studying university courses, I started to learn Front-end knowledge such as HTML5, CSS3, JavaScript, jQuery, etc. After that, I moved on to learn Front-end frameworks. The first framework I learned is Angular JS, then Angular2. After I got in touch with Reach JS, I found myself comfortable with the JSX. Then I started up developing and implementing webpages using React JS.</p>
